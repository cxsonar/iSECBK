# Insecure Bank
![Insecure-Bank](https://axxissecurity.com/img/bank.png)
## Running the application locally

1. Clone the repository:

        $ git clone https://github.com/axxis/insecure-bank.git
...
Place axxis agent and license in the application root folder.
